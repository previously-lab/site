---
title: Local First
description: The local client is Previously's optional form — the same kernel as an npm package running on your own machine, memory on hardware you own from day one.
---
