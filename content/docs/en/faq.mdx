...
No. Previously is experimental v0.3.1. The README carries an "experimental" status badge and explicitly states it is "not yet ready for personal or production use." The `APP_VERSION` constant is `0.3.1`.
