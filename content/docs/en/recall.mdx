...
1. **Reasoning** — Brain icon, expandable card, inside the bubble
2. **Recall / tools** — History / tool icons, inline cards
3. **Response** — text + inline tool calls, inside the bubble
