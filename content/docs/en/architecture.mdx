...
Around the main agent sit three colleagues with independent judgment (recall, webSearch, thinkDeep) and a Darwinian self-evolution loop. Each deserves its own page: [Colleagues, Not Tools](/docs/colleagues) and [The Evolution Loop](/docs/evolution). Architecturally only one thing matters here: they all obey the same discipline — evidence anchoring, with evolution writes confined to a single writer — and where that discipline is enforced is the next section.
